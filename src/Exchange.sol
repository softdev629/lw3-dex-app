...
contract Exchange is ERC20 {
    ...
    // as it is responsible for miniting and issuing LP Tokens
    constructor(address token) ERC20("ETH TOKENLP Token", "lpETHTOKEN") {
    ...
    function addLiquidity(
        ...
        // Trnasfer the token from the user to the exchange
    ...
    function removeLiquidity(
        ...
        require(
            amountOfLPTokens > 0,
            "Amount of tokens to remove must be greather than 0"
        );
        uint256 ethReserveBalance = address(this).balance;
    ...
    function tokenToEthSwap(
        ...
        require(
            ...
            "ETH received are less than minimum ETH expected"
        );
